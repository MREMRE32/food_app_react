  ...
  return (
    <div className="w-full flex items-center justify-between gap-3">
      ...
      <div className=" flex items-center justify-end gap-4">
        <div className="flex items-center justify-end gap-3 px-4 py-2 bg-lightOverlay backdrop-blur-md rounded-md shadow-md">
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <motion.div
            ...
            className=" w-10 h-10 rounded-md cursor-pointer bg-lightOverlay backdrop-blur-md shadow-md flex items-center justify-center"
          >
            <MdLogout className="text-grey-400 text-xl" />
          </motion.div>
        </div>
      </div>
    </div>
