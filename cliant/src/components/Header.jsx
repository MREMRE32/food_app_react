...
const Header = () => {
  ...
  return (
    <header className="fixed backdrop-blur-md z-50 inset-x-0 flex items-center justify-between px-12 md:px-20 py-6">
      ...
      <nav className="flex items-center justify-center gap-8">
        ...
        {user ? (
          <>
            ...
            >
              <div className="w-12 h-12 rounded-full shadow-md cursor-pointer overflow-hidden flex-auto items-center justify-center">
                <motion.img
